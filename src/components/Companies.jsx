...
export default function Companies() {
  ...
  return (
    <section id="companies" className="bg-black text-white py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          <h2 className="text-3xl sm:text-4xl font-semibold">As 4 empresas do grupo</h2>
          <p className="mt-3 text-white/70">Somos um grupo com quatro frentes que se complementam e trabalham integradas, do planejamento à execução.</p>
        </div>
